...
var TidyTree = (function () {
  ...
  TidyTree.prototype.draw = function (selector) {
    ...
    let parent = (this.parent = div.select(selector ? selector : this.parent));
...
var simulation = d3.forceSimulation(data)
  ...
  .force("y", d3.forceY()
    ...
    .strength(0.01))
  .force("center", d3
    .forceCenter(treeWidth + ((width - treeWidth) / 2), height / 2))
  .force("link", d3
    .forceLink()
    .links(links())
...
let tidyTree = new TidyTree(options["tree"], {
  parent: "#treeDiv",
  layout: "horizontal",
  type: "weighted",
  mode: "square",
...
var setRadius = optionsDiv.append("div")
      .attr("id", "setRadius")
      .style("background-image", sliderGradient(100))
      .style("border", "black solid 1px")
      .style("width", "200px")
